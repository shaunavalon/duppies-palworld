...
ENV DEBIAN_FRONTEND=noninteractive \
    ...
    PAL_EGG_DEFAULT_HATCHING_TIME=720.000000 \
    ...
    MAX_PLAYERS=32 \
    SERVER_NAME="Duppies Palworld" \
    SERVER_DESCRIPTION="Duppies Palworld Server" \
    ADMIN_PASSWORD=shopeasybottle \
    SERVER_PASSWORD=cloudstandzipper \
    PUBLIC_PORT=8211 \
    PUBLIC_IP= \
    RCON_ENABLED=true \
    RCON_PORT=25575 \
